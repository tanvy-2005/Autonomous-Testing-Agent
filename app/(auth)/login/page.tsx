      ...
      <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            ...
            <Link href="#" className={`text-[11px] font-medium hover:underline ${isDark ? 'text-blue-400' : 'text-blue-600'}`}>
              Forgot password?
            </Link>
          </div>
          <Input
        ...
        <div className="flex items-center space-x-2 pt-0.5 pb-2">
          <Checkbox id="remember" className={`h-3.5 w-3.5 border data-[state=checked]:bg-blue-600 ${isDark ? 'border-white/20' : 'border-black/20'}`} />
          <label
            htmlFor="remember"
